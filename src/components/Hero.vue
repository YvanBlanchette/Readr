...
<template>
 <section class="relative h-[calc(100vh-180px)] w-full">
  <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 w-3/4  flex flex-col items-center gap-8">
